...
class ResetAllTest(TestCase):
    ...
    @patch('colorama.initialise.AnsiToWin32')
    def test_reset_all_calls_reset_all_with_original_stdout(self, mockATW32):
        prev_stdout = sys.stdout
        ...
        self.assertTrue(mockATW32.return_value.reset_all.called, 'reset_all should be called')
